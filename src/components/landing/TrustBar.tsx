...
const BANK_LOGOS: Record<(typeof PARTNER_BANKS)[number], string> = {
  ...
  'SunTrust': '/images/banks/suntrust.svg',
  ...
  'First Republic': '/images/banks/firstrepublic.svg',
